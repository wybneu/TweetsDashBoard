...
//             System.out.println(download.negTweets[id].message);
            ...
            out.close();
                ...
                .equalsIgnoreCase("hotUserdetails")) {
            int id = Integer.valueOf(request.getParameter("id").toString());
            ...
            PrintWriter out = response.getWriter();
            out.print("{\"user\":\"" + download.users[id].name
                    +"\",\"id\":\""+download.users[id].getId_str()
                    +"\",\"count\":\""+download.users[id].getFollowers_count()+"\"}");
//             System.out.println("{\"user\":\"" + download.users[id].name
//                     +"\",\"id\":\""+download.users[id].getId_str()
//                     +"\",\"count\":\""+download.users[id].getFollowers_count()+"\"}");
            out.close();
        } 
        else if (request.getParameter("request").toString()
                .equalsIgnoreCase("posdetails")) {
            response.setContentType("application/json");
            PrintWriter out = response.getWriter();  
//            System.out.println(download.getSpeed());
            out.print(download.getPos());
            out.close();  
        } 
        else if (request.getParameter("request").toString()
                .equalsIgnoreCase("negdetails")) {
            response.setContentType("application/json");
            PrintWriter out = response.getWriter();  
//            System.out.println(download.getSpeed());
            out.print(download.getNeg());
            out.close();    
        } else {
            int id = Integer.valueOf(request.getParameter("id").toString());
            response.setContentType("application/html");
